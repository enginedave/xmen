...
module.exports = {
	//db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/xmen',
	...
	db: 'mongodb://enginedave:dave4368@ds053539.mongolab.com:53539/dgdb',
