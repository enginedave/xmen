...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('regulations');
'use strict';

// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('superheroes');
'use strict';
	...
	function($scope, Authentication) {
		...
		$scope.alerts = [
			...
			},
			{
				...
				color: 'btn-warning',
				total: '268',
				description: 'FOLLOWS UPS REQUIRED'
			},
			{
				icon: 'glyphicon-flag',
				color: 'btn-danger',
...
customersApp.controller('CustomersController', ['$scope', '$stateParams', 'Authentication', 'Customers', '$modal', '$log',
	function($scope, $stateParams, Authentication, Customers, $modal, $log) {
		...
		this.modalUpdate = function (size, selectedCustomer) {
			//alert('the chosen customer is '+ selectedCustomer.firstName);
